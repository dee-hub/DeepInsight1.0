HEADER_INFO = """""".strip()
SUB_HEADER = """
<i> Auto-updates every minute <i>
"""
DEVELOPER = """
    <div class="contributors font-body text-bold">
        Developed by: <i><b><a class="contributor comma" href="https://linkedin.com/in/oluwadolapo-salako">Oluwadolapo Salako</a></b><i>
        </div>
"""
CHEF_INFO = """
        <h2 class="font-title">CodE ziLLA! </h2>
        <p class="strong font-body">
        <span class="d-block extra-info">(Code Generator.)</span>
        </p>
""".strip()
